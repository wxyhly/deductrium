...
export class Assist {
    ...
    intro(s: string) {
        ...
        if (goal.context.find(e => e[0] === s)) { this.goal.unshift(goal); throw TR("无法重复intro相同变量名"); }
    ...
    genReplaceFn(ast: AST, search: AST, varname: string, excludedNames: Set<string>): AST {
