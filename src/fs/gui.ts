...
export class FSGui {
    ...
    updateDeductionList() {
        this.updateGuiList("", this.deductions.map(d => this.formalSystem.deductions[d] || this.formalSystem.generateDeduction(d)), this.deductionList,
    ...
    getDeduction(id: string) {
        ...
        if (this.formalSystem.deductions[id]) return this.formalSystem.deductions[id];
