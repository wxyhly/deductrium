...
class LangMgr {
    ...
    dataEnInCanvas = {
        ...
        "解锁证据pred_succZ\n解锁证明策略eq后\n可自动化简相应表达式": "Unlock the proof pred_succZ\nAfter unlocking the eq strategy\ncorresponding expressions\ncan be simplified automatically",
        "解锁证据succ_predZ\n解锁证明策略eq后\n可自动化简相应表达式": "Unlock the proof succ_predZ\nAfter unlocking the eq strategy\ncorresponding expressions\ncan be simplified automatically",
        ...
        "解锁证据transright": "Unlock the proof transright",
        "解锁证据transleft": "Unlock the proof transleft",
        "解锁证据transleftright": "Unlock the proof transleftright",
