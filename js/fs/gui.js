...
export class FSGui {
    ...
    displayDs = new Set();
    deductions = [];
    metarules = ["q", "cdt", "idt", "dt", "vt", "cvt", "cmt", "ifft", "cpt"];
    ...
    updateDeductionList() {
        this.updateGuiList("", this.deductions.map(d => this.formalSystem.deductions[d]), this.deductionList, (p) => (this.displayDs.has(p.from) || (this.displayDs.has("添加的规则") && p.from.endsWith("*"))), (p, itInfo, it) => {
    ...
    getDeduction(id) {
        ...
        if (this.formalSystem.deductions[id])
